...
export function HeroTitle() {
  ...
  return (
    <h1 className="mt-3 wrap-break-word font-display text-[clamp(3.4rem,min(26vw,1.5rem+14vw),4rem)] min-[360px]:text-[clamp(4.8rem,min(26vw,1.5rem+14vw),9.25rem)] font-bold uppercase leading-[0.86] tracking-[0.01em] text-[#e8dcc0] xl:text-[11vw]">
